...
public class Entity {
	...
	public static BufferedImage PLAYER_SPRITE = Game.spritesheet.getSprite(0,64,Player.PLAYER_SIZE,Player.PLAYER_SIZE);
	
	public static BufferedImage ENEMY1 = Game.spritesheet.getSprite(16*7, 0, ENTITY_SIZE, ENTITY_SIZE);
	
	public static BufferedImage COIN = Game.spritesheet.getSprite(32, 16, ENTITY_SIZE, ENTITY_SIZE);
